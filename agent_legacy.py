"""
LEGACY — GDG Tirana hackathon agent (LiveKit + GPT-4o + Deepgram + Cartesia).
NOT used by the current local server (server.py). Kept for reference only.

To run this you need a LiveKit server and the packages in requirements-legacy-agent.txt.
"""
