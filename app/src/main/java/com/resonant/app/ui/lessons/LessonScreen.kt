    ...
    ResonantScaffold(
        ...
        GestureSurface(onGesture = { gesture ->
                ...
                ResonantGesture.ThreeFingerHold -> {
                    ...
                    audio.announce(
                        "You are in ${lesson.title}, section ${lastSectionIndex + 1} of ${lesson.sections.size}. " +
                            "Audio is ${if (audio.isPaused.value) "paused" else "playing"} at $speedLabel times speed."
                    )
                }
            ...
            Column(Modifier.fillMaxSize().padding(24.dp)) {
                ...
                Text(
                    "Unit ${flatIndex + 1} of ${flat.size} · Swipe up/down for units, left/right for sections",
